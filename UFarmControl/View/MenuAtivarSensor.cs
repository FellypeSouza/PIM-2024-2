...
{
    public partial class MenuAtivarSensor : Form
    {
        ...
        public MenuAtivarSensor(SensorTemperatura SensorTemperatura, 
        ...
        {
            if (comboBoxAtivarSensor.Text == "Sensor de Temperatura")
            {
                SensorTemperatura.setStatus(true);
                
            }
            else if (comboBoxAtivarSensor.Text == "Sensor de Umidade")
            {
                SensorUmidade.setStatus(true);
            }
            else if(comboBoxAtivarSensor.Text == "Sensor de Luminosidade")
            {
                SensorLuminosidade.setStatus(true);
            }
            else if(comboBoxAtivarSensor.Text == "Sensor de CO2")
            {
